...
- **路径**: `/home/dhtaiyi/.openclaw/workspace/image_creator.png`
- **大小**: 101KB
- **描述**: 美丽的内容创作者在粉色书桌前工作，笔记本电脑显示AI助手

### 📷 封面图3: 多模型主题
- **文件**: `image_tech.png`
- **路径**: `/home/dhtaiyi/.openclaw/workspace/image_tech.png`
- **大小**: 63KB
...
### 方式1: 使用下载脚本
```bash
bash /home/dhtaiyi/.openclaw/workspace/download_images.sh
```
...
# 下载封面图2
scp root@你的服务器IP:/home/dhtaiyi/.openclaw/workspace/image_creator.png ./

# 下载封面图3
scp root@你的服务器IP:/home/dhtaiyi/.openclaw/workspace/image_tech.png ./
```

### 方式3: 从文件管理器访问
直接访问服务器路径：
```
/home/dhtaiyi/.openclaw/workspace/*.png
```
